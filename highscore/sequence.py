...
class EntrySequenceManager(game.Mode):
    ...
    def mode_started(self):
        ...
        self.next()
        self.fanfareSounds = [self.game.assets.sfx_fireworks1,self.game.assets.sfx_fireworks2]
    ...
    def create_highscore_entry_mode(self, left_text, right_text, entered_handler):
        ...
        return InitialEntryMode(game=self.game, priority=self.priority+1, left_text=left_text, right_text=right_text, entered_handler=entered_handler,max_inits=3)
    ...
    def highscore_entered(self, mode, inits):
        ...
        self.fanfareIndex = 0
        self.fanfareCount = len(self.active_prompt.right)
        self.fanfare(inits)
    ...
    def fanfare(self,inits):
        ...
        textLayer2 = ep.EP_TextLayer(64, 9, self.game.assets.font_15px_az,"center",opaque=False).set_text(inits,color=ep.ORANGE)
